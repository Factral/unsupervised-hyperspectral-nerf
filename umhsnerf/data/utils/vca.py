...
# 
  ...
  for i in range(R):
    ...
    # check if any is nan or inf in A matrix
...
if __name__ == "__main__":
    ...
    # Load the data
    Y = np.load('data/processed/ajar/train/r_1.npy')
    Y = Y.transpose(2, 0, 1).reshape(Y.shape[2], -1)
    ...
    print('Endmembers extracted:')
    print(Ae.T.shape)

    print('Indices of pixels chosen:')
    print(indice.shape)
